...
/*!
 @header Upload+Remote
 @abstract Remote category for Upload class
 */

#import "Upload.h"

/*!
 @category Upload (Remote)
 @abstract Adds remote CRUD capabilities to Upload.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface Upload (Remote)
